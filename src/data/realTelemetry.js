export const REAL_TELEMETRY = Object.freeze({
  ...
  privacy:"Raw identifiers were intentionally not committed. Values below are sanitized aggregates from the supplied local Windows snapshot.",
  defender:{
  ...
  windowsEvents:{
    parsedRows:3057,levels:{information:2308,warning:315,error:239,verbose:194},
    topEventIds:[
    ...
    providers:[
      {name:"Security-Auditing",count:156},{name:"Hyper-V-VmSwitch",count:142},{name:"LiveId",count:79},{name:"WMI-Activity",count:78},{name:"Security-Mitigations",count:53},{name:"CodeIntegrity",count:43}
    ],
    samples:[
